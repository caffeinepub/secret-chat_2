...
import type { ExternalBlob as _ExternalBlob, Message as _Message, SignalingData as _SignalingData, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addIceCandidateAnswerer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addIceCandidateAnswerer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addIceCandidateOfferer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addIceCandidateOfferer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearSignaling(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearSignaling();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSignaling(): Promise<SignalingData | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSignaling();
    ...
    async sendMessage(arg0: string, arg1: string, arg2: string | null, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, to_candid_opt_n17(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n17(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeAnswer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeAnswer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeOffer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeOffer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Message_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Message): Promise<Message> {
    return await from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_SignalingData_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SignalingData): SignalingData {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SignalingData]): SignalingData | null {
    return value.length === 0 ? null : from_candid_SignalingData_n15(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        blob: record_opt_to_undefined(await from_candid_opt_n11(_uploadFile, _downloadFile, value.blob)),
        text: value.text,
        sender: value.sender,
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        answerSDP: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.answerSDP)),
        iceCandidatesAnswerer: value.iceCandidatesAnswerer,
        offerSDP: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.offerSDP)),
        iceCandidatesOfferer: value.iceCandidatesOfferer
    };
}
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Message>): Promise<Array<Message>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Message_n9(_uploadFile, _downloadFile, x)));
}
